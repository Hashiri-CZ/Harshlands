...
public class NtpModule extends HLModule {
    ...
    public NtpModule(HLPlugin plugin) {
    ...
    public void initialize() {
        ...
        HLPlugin.getPlugin().getDebugManager().registerProvider(new cz.hashiri.harshlands.debug.DebugProvider() {
            ...
            @Override public java.util.Collection<String> getSubsystems() { return java.util.List.of("Tools", "FireStarter"); }
        });
