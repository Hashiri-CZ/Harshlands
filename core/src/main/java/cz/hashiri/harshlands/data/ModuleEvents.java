...
public abstract class ModuleEvents implements Listener {
    ...
    public ModuleEvents(HLModule module, HLPlugin plugin) {
        this.module = module;
        this.plugin = plugin;
                    ...
                    if (entity.getType().toString() != null) {
                        ...
                        for (String item : itemKeys) {
                            if (HLItem.isHLItem(item))
                                Utils.dropLooting(section.getConfigurationSection(item), HLItem.getItem(item), tool, entity.getLocation(), true);
                        }
                    }
                }
            }
    ...
    public void onAnvil(PrepareAnvilEvent event) {
        ...
        Set<HLAnvilRecipe> anvilRecipes = module.getModuleRecipes().getAnvilRecipes();
