...
public class HyperthermiaTask extends BukkitRunnable implements HLTask {
    ...
    public HyperthermiaTask(TanModule module, HLPlugin plugin, HLPlayer player) {
        this.plugin = plugin;
        this.module = module;
    ...
    public void run() {
        ...
        if (conditionsMet(player)) {
            if (!player.hasPermission("harshlands.toughasnails.resistance.hot.damage")) {
            ...
            if (!player.hasPermission("harshlands.toughasnails.resistance.hot.potioneffects")) {
            ...
            if (!player.hasPermission("harshlands.toughasnails.resistance.hot.combustion")) {
