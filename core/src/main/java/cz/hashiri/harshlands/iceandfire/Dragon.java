...
import cz.hashiri.harshlands.utils.LorePresets;
...
public interface Dragon extends HLMob {
    ...
    default List<ItemStack> getLoot(@Nullable ItemStack tool) {
        ...
        ItemStack heart = HLItem.getItem("dragon_heart_" + breed);
        ItemStack skull = HLItem.getItem("dragon_skull_" + breed);
        ItemStack scales = HLItem.getItem("dragonscale_" + getVariant().toString().toLowerCase());
        ItemStack blood = HLItem.getItem("dragon_blood_" + breed);
        ItemStack flesh = HLItem.getItem("dragon_flesh_" + breed);
        ItemStack bones = HLItem.getItem("dragonbone");
    ...
    default void applyConfigOptions() {
        ...
        ConfigurationSection section = HLModule.getModule(getParentModule()).getUserConfig().getConfig().getConfigurationSection("Dragon.Info");
